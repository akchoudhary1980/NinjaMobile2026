 ...
 */
        public static readonly MudTheme Themetheme = new()
        {
            PaletteLight = new PaletteLight()
            {
                ...
                PrimaryDarken = "#f74747ff",
                PrimaryLighten = "#fa8181ff",
                SecondaryDarken = "#067ff6ff",
                SecondaryLighten = "#56aafeff",
                TertiaryDarken = "#313131ff",
                TertiaryLighten = "#7f7f7fff",
